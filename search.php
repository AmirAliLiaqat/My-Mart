...
<body>
    ...
    <section class="banner p-3">
        <div class="container text-center text-white p-5">
            <h1>Search</h1>
            <div class="links">
                <a href="index.php" class="nav-link d-inline">Home</a> / <span>&nbsp;&nbsp; Search</span>
            </div><!--links-->
        </div><!--container-->
    </section>

    <section class="search_box">
        <div class="container products_container p-5">
            <div class="search_box_div">
                <form action="" method="post" class="d-flex">
                    <input type="search" name="search_box" id="search" class="form-control" placeholder="search anything">&nbsp;&nbsp;
                    <input type="submit" name="search_btn" class="btn btn-primary btn-lg" value="search">
                </form>
            </div><!--search_box_div-->
            <div class="row d-flex justify-content-center mt-5">
                <?php
                    ...
                    if(isset($_POST['search_btn'])) {
                        ...
                        $fetch_products = "SELECT * FROM `products` WHERE `name` = '$search_box' AND `product_status` = 'publish'";
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 mb-3">
                    <div class="inner_content bg-white text-dark text-center dashboard_div p-3">
                        ...
                        <a href="search.php?id=<?php echo $row['id']; ?>&product_img=<?php echo $row['product_img']; ?>&name=<?php echo $row['name']; ?>&price=<?php echo $row['price']; ?>" class="btn btn-primary btn-lg mt-3"><i class="fa-solid fa-cart-shopping"></i></a>
                        <?php } ?>
                    </div><!--inner_content-->
                </div><!--col-lg-4-->
                <?php
